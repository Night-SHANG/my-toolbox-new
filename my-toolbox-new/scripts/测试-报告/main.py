...
def get_metadata():
    """定义脚本的元数据"""
    return {'name': '测试-报告', 'description': '一个演示多文件脚本如何工作的示例。它会从辅助模块导入函数来生成一份报告。', 'dependencies': [], 'parameters': [{'name': 'mood', 'type': 'text', 'label': '今日心情', 'defaultValue': '不错'}, {'name': 'notes', 'type': 'textarea', 'label': '备注', 'placeholder': '记录一下今天发生的事吧...'}], 'category': '测试', 'icon': 'C:\\Users\\Night Shang\\Desktop\\gjx\\my-toolbox-new\\assets\\icons\\icon-mo.ico'}
