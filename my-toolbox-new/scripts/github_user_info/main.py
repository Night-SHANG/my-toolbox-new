...
def get_metadata():
    """获取脚本元数据"""
    return {'name': 'github_user_info', 'description': '查询指定GitHub用户的信息，并将其头像转为字符画。', 'dependencies': ['requests', 'ascii_magic'], 'parameters': [{'name': 'username', 'type': 'text', 'label': 'GitHub 用户名', 'required': True, 'defaultValue': 'torvalds'}], 'category': '测试', 'icon': 'C:\\Users\\Night Shang\\Desktop\\gjx\\my-toolbox-new\\assets\\icons\\icon-mo.ico'}
